    ...
    var Corrensa_Settings_JS = {
        ...
        registerLoginFormEvents: function () {
            $('#loginForm').submit(function (e) {
                ...
                var funcSyncPermission = function(userId, userIds) {
                    ...
                    AppConnector.request(params = {
                        ...
                        if(response && response.success && response.finish) {
            ...
            $('#corrensa-lost-password-screen').on('shown.bs.modal', function () {
                ...
                var top = ((hBo - height) / 2) + 250 + 'px';
                var left = ((wBo - width) / 2) + 280 + 'px';

                if(width > 1200) {
                    width = wBo / 100 * 35;
                    height = 330;
                    top = ((hBo - height) / 2) + 250 + 'px';
                    left = ((wBo - width) / 2) + 280 + 'px';
                ...
                $('#corrensa-lost-password-screen .modal-body').height($('#corrensa-lost-password-screen').height() - 37);
            });
        ...
        registerSignupEvents: function () {
            ...
            $('#corrensa-register-screen').on('shown.bs.modal', function () {
                ...
                $('#corrensa-register-screen .modal-body').height($('#corrensa-register-screen').height() - 37);
            });
