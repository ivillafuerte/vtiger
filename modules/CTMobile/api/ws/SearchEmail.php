...
class CTMobile_WS_SearchEmail extends CTMobile_WS_FetchRecord {
	...
	*/
	...
	function process(CTMobile_API_Request $request) {
		...
		if ($folder!='' && $maxEntriesPerPage!='' && $page!='' && $q!='') {
			...
			$response->setResult(array('pageInfo' =>$folder->pageInfo(),'search_email'=>$folderMails, 'module'=>'MailManager', 'msg'=>''));
			return $response;
		}else{
