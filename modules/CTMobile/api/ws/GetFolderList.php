...
class CTMobile_WS_GetFolderList extends CTMobile_WS_FetchRecord {
	...
	function process(CTMobile_API_Request $request) {
		...
		if ($adb->num_rows($result)) {
			...
			$response->setResult(array('folderList'=>$folderListWithCount, 'module'=>'MailManager', 'mUsername'=>$this->mUsername, 'msg'=>''));
		}else{
			throw new WebServiceException(404,"No MailBox found. Please Create Mailbox");
		}	
