...
class CTMobile_WS_AttendanceUserStatus extends CTMobile_WS_Controller {
	...
	function process(CTMobile_API_Request $request) {
		...
		if( $num_rows > 0){
			$response->setResult(array('attendance_status'=>true, 'module'=>'CTAttendance', 'msg'=>''));
		} else {
			$response->setResult(array('attendance_status'=>false, 'module'=>'CTAttendance', 'msg'=>''));
		}
		return $response;
	}
