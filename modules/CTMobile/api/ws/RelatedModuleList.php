...
class CTMobile_WS_RelatedModuleList extends CTMobile_WS_Controller {
	...
	function process(CTMobile_API_Request $request) {
		...
		if ($fetchrecord == '') {
			$allrelatedid =  array('relatedtabid' => $relatedmoduleentitytabid,'relatedModuleName'=>$relatedModuleName,'relatedfieldname'=>$relatedfieldnamelist,'fetchrecord'=>array());
		}else{

			$allrelatedid =  array('relatedtabid' => $relatedmoduleentitytabid,'relatedModuleName'=>$relatedModuleName,'relatedfieldname'=>$relatedfieldnamelist,'fetchrecord'=>$fetchrecord);
		}
