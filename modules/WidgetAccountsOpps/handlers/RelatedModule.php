...
class WidgetAccountsOpps_RelatedModule_Handler extends WidgetAccountsOpps_Basic_Handler {
    public function getUrl() {
        $moduleName=Vtiger_Functions::getModuleName($this->Data['relatedmodule']);
        return 'module=WidgetAccountsOpps&view=SummaryWidget&record='.$this->Record.'&mode=showRelatedWidget&relatedModule='.$moduleName.'&page=1&limit='.$this->Data['limit'];
    }
